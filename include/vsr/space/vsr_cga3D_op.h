...
#ifndef VERSOR_VSR_SPACE_CGA3D_OP_H_
#define VERSOR_VSR_SPACE_CGA3D_OP_H_
...
#define EP \
  vsr::cga::Dls(0, 0, 0, 1, -.5)  ///< unit vsr::cga::DualSphere at origin: swap with infinity for hyperbolic space
#define EM                  \
  vsr::cga::Dls(0, 0, 0, 1, \
